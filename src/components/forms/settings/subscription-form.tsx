...
const SubscriptionForm = ({ plan }: Props) => {
  const { loading, onSetPayment, payment, onUpdatetToFreeTier } =
    ...
    <Loader loading={loading}>
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-3">
          <SubscriptionCard
            title="STANDARD"
            description="Perfect if you’re just getting started with Maildodo AI"
            price="0"
            payment={payment}
        ...
        {payment === "STANDARD" && (
          <Button onClick={onUpdatetToFreeTier}>
